...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'High Valyrian');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'High Valyrian Translator API',
    description: 'Gemini 2.0 Flash powered English to High Valyrian translation service',
    features: [
      'AI-powered translation',
      'Game of Thrones language processing',
