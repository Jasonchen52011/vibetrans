...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Greek');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Greek Translator API',
    description: 'Gemini 2.0 Flash powered English to Greek translation service',
    features: [
