...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Gen Alpha Slang');
...
export async function GET() {
  return NextResponse.json({
    ...
    description: 'Gemini 2.0 Flash powered English to Gen Alpha Slang translation service',
    features: [
      'AI-powered translation',
      'Gen Alpha slang processing',
