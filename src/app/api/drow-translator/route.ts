...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Drow Language');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Drow Translator API',
    description: 'Gemini 2.0 Flash powered English to Drow Language translation service',
    features: [
      'AI-powered translation',
      'Fantasy language processing',
