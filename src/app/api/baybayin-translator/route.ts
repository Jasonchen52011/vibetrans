...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Baybayin');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Baybayin Translator API',
    description: 'Gemini 2.0 Flash powered English to Baybayin translation service',
    features: [
