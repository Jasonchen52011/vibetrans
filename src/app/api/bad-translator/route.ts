...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Bad Translation Style');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Bad Translator API',
    description: 'Gemini 2.0 Flash powered English to Bad Translation Style service',
    features: [
      'AI-powered translation',
      'Humorous translation style',
