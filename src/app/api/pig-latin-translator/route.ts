...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Pig Latin');
...
export async function GET() {
  return NextResponse.json({
    ...
    description: 'Gemini 2.0 Flash powered English to Pig Latin translation service',
    features: [
      'AI-powered translation',
      'Pig Latin language processing',
