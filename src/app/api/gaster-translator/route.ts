...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Gaster Language');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Gaster Translator API',
    description: 'Gemini 2.0 Flash powered English to Gaster Language translation service',
    features: [
