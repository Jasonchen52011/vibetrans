...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Esperanto');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Esperanto Translator API',
    description: 'Gemini 2.0 Flash powered English to Esperanto translation service',
    features: [
      'AI-powered translation',
      'Constructed language processing',
