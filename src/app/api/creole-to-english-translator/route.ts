...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'Creole');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'Creole To English Translator API',
    description: 'Gemini 2.0 Flash powered Creole to English translation service',
    features: [
