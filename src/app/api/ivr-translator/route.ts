...
export async function POST(request: NextRequest) {
  try {
    ...
    const translated = await translateWithGemini(text, 'IVR Script Style');
...
export async function GET() {
  return NextResponse.json({
    status: 'healthy',
    service: 'IVR Translator API',
    description: 'Gemini 2.0 Flash powered English to IVR Script Style translation service',
    features: [
      'AI-powered translation',
      'IVR script processing',
