/**
 * English to Chinese Translator API - 简化版本
 */
...
export async function GET() {
  return Response.json({
    status: 'healthy',
    message: 'English to Chinese Translator API is running',
...
export async function POST(request: Request) {
  try {
    ...
    // 简单的降级方案
    const fallbackTranslation = `${text} (翻译成中文 - 演示模式)`;
