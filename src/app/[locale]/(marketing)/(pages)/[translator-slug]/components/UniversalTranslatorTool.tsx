...
/**
 * 🎯 Universal Translator Tool Component
 *
 * This component handles ALL translator tools dynamically.
 * It uses the Gemini API for intelligent translation.
 *
 * Features:
 * - Text input and file upload (.txt, .docx)
...
// import { TextToSpeechButton } from '@/components/ui/text-to-speech-button'; // TODO: Component doesn't exist yet

interface UniversalTranslatorToolProps {
  pageData: any;
  locale?: string;
  slug: string;
  toolName: string;
...
export default function UniversalTranslatorTool({
  pageData,
  locale = 'en',
  slug,
  toolName,
}: UniversalTranslatorToolProps) {
  ...
  // Generate context based on slug
  const getTranslationContext = () => {
    ...
    const contexts: Record<string, string> = {
      ...
      'draconic-translator':
        'Translate English text into Draconic, the ancient language of dragons from D&D and fantasy role-playing games. Use harsh, guttural sounds and draconic script conventions. Examples: "Hello" → "Ghik", "Friend" → "Arux", "Fire" → "Darastrix". Output ONLY the Draconic translation without any prefixes, explanations, or labels.',
