...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'MandalorianTranslatorPage' });
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <MandalorianTranslatorTool pageData={translatorContent.pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="MandalorianTranslatorPage" subNamespace="testimonials" />

        {/* FAQ */}
        <FaqSection namespace="MandalorianTranslatorPage" subNamespace="faqs" />

        {/* CTA */}
        <CallToActionSection namespace="MandalorianTranslatorPage" subNamespace="cta" />
      </div>
    </>
  );
}
