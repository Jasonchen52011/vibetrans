...
export async function generateMetadata({
  ...
  const gt = await getTranslations({ locale, namespace: 'HelpPage' });

  return constructMetadata({
    title: `${gt('title')} | ${(t as any)('name')}`,
    description: gt('description'),
    canonicalUrl: getUrlWithLocale('/--help', locale),
    image: '/images/docs/what-is---help.webp',
  });
}
...
export default async function HelpPage(props: HelpPageProps) {
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: '/images/docs/what-is---help.webp',
      alt: 'What is Help',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src: '/images/docs/--help-how-to.webp',
      alt: 'How to use Help',
    },
    items: [
      {
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/--help-fact-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/--help-fact-2.webp',
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/--help-interest-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/--help-interest-2.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/--help-interest-3.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/--help-interest-4.webp',
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <HelpTool pageData={pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="HelpPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="HelpPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="HelpPage.cta" />
      </div>
    </>
  );
}
