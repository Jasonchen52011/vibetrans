...
interface PigLatinTranslatorToolProps {
  pageData: any;
  locale?: string;
}

export default function PigLatinTranslatorTool({
  pageData,
  locale = 'en',
}: PigLatinTranslatorToolProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      const response = await fetch('/api/pig-latin-translator', {
        method: 'POST',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'pig-latin-translator', {
        onSuccess: () => {},
