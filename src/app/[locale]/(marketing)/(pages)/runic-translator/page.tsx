...
import RunicTranslatorTool from './RunicTranslatorTool';
...
interface RunicTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function RunicTranslatorPage(
  props: RunicTranslatorPageProps
) {
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <RunicTranslatorTool pageData={translatorContent.pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="RunicTranslatorPage" subNamespace="testimonials" />

        {/* FAQ */}
        <FaqSection namespace="RunicTranslatorPage" subNamespace="faqs" />

        {/* CTA */}
        <CallToActionSection namespace="RunicTranslatorPage" subNamespace="cta" />
      </div>
    </>
  );
}
