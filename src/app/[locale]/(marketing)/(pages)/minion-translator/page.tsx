    ...
    items: [
      {
        ...
        description: (t as any)('userInterest.items.0.content'),
        image: {
      ...
      },
      {
        ...
        description: (t as any)('userInterest.items.1.content'),
        image: {
      ...
      },
      {
        ...
        description: (t as any)('userInterest.items.2.content'),
        image: {
      ...
      },
      {
        ...
        description: (t as any)('userInterest.items.3.content'),
        image: {
  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="MinionTranslatorPage.testimonials" />
