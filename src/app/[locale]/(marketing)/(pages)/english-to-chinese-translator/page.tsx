...
import EnglishToChineseTranslatorTool from './EnglishToChineseTranslatorTool';
...
interface EnglishToChineseTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function EnglishToChineseTranslatorPage(
  props: EnglishToChineseTranslatorPageProps
) {
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <EnglishToChineseTranslatorTool pageData={pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="EnglishToChineseTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="EnglishToChineseTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="EnglishToChineseTranslatorPage.cta" />
      </div>
    </>
  );
}
