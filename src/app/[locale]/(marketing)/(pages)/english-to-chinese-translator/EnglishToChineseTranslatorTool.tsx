...
interface EnglishToChineseTranslatorToolProps {
  pageData: any;
  locale?: string;
}

export default function EnglishToChineseTranslatorTool({
  pageData,
  locale = 'en',
}: EnglishToChineseTranslatorToolProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      // TODO: 替换为你的 API 端点
      const response = await fetch('/api/english-to-chinese-translator', {
        method: 'POST',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'english-to-chinese-translator', {
        onSuccess: () => {},
