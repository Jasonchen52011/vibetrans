...
export default function EnglishToAmharicTranslatorTool({
  pageData,
  locale = 'en',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'english-to-amharic-translator', {
        onSuccess: () => {},
          ...
          <div className="flex-1">
            ...
            >
              {isLoading ? (
                ...
                <p className="text-lg whitespace-pre-wrap w-full text-start">
                  {outputText}
                </p>
              ) : (
