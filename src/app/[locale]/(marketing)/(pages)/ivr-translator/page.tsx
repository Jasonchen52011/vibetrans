...
import IvrTranslatorTool from './IvrTranslatorTool';
...
export async function generateMetadata({
  ...
  const gt = await getTranslations({ locale, namespace: 'IvrTranslatorPage' });

  return constructMetadata({
    title: `${gt('title')} | ${(t as any)('name')}`,
    description: gt('description'),
    canonicalUrl: getUrlWithLocale('/ivr-translator', locale),
    image: '/images/docs/what-is-ivr-translator.webp',
  });
}

interface IvrTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function IvrTranslatorPage(props: IvrTranslatorPageProps) {
  const params = await props.params;
  const { locale } = params;
  const t = await getTranslations({ locale, namespace: 'IvrTranslatorPage' });

  // Structured Data for SEO
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Ivr Translator',
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: '/images/docs/what-is-ivr-translator.webp',
      alt: 'What is Ivr Translator',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src: '/images/docs/ivr-translator-how-to.webp',
      alt: 'How to use Ivr Translator',
    },
    items: [
      {
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-fact-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-fact-2.webp',
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-interest-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-interest-2.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-interest-3.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/ivr-translator-interest-4.webp',
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <IvrTranslatorTool pageData={pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="IvrTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="IvrTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="IvrTranslatorPage.cta" />
      </div>
    </>
  );
}
