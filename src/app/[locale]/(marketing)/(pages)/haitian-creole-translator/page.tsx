...
import HaitianCreoleTranslatorTool from './HaitianCreoleTranslatorTool';
...
export async function generateMetadata({
  ...
  return constructMetadata({
    ...
    canonicalUrl: getUrlWithLocale('/haitian-creole-translator', locale),
    image: t('whatIs.image'),
  });
}

interface HaitianCreoleTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function HaitianCreoleTranslatorPage(
  props: HaitianCreoleTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Haitian Creole Translator',
    description: t('description'),
  });
