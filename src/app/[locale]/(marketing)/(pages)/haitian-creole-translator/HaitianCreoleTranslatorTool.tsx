...
interface HaitianCreoleTranslatorToolProps {
  pageData: any;
  locale?: string;
}

export default function HaitianCreoleTranslatorTool({
  pageData,
  locale = 'en',
}: HaitianCreoleTranslatorToolProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      const response = await fetch('/api/haitian-creole-translator', {
        method: 'POST',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'haitian-creole-translator', {
        onSuccess: () => {},
