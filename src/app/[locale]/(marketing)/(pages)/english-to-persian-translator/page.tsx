...
export default async function EnglishToPersianTranslatorPage(
  ...
  const examplesData = {
    ...
    examples: [
      ...
      {
        before: t('examples.items.1.before'),
        after: t('examples.items.1.after'),
        alt: t('examples.items.1.alt'),
      },
      {
        before: t('examples.items.2.before'),
        after: t('examples.items.2.after'),
        alt: t('examples.items.2.alt'),
      },
      {
        before: t('examples.items.3.before'),
        after: t('examples.items.3.after'),
        alt: t('examples.items.3.alt'),
      },
      {
        before: t('examples.items.4.before'),
        after: t('examples.items.4.after'),
        alt: t('examples.items.4.alt'),
      },
      {
        before: t('examples.items.5.before'),
        after: t('examples.items.5.after'),
