...
interface JapaneseToEnglishTranslatorToolProps {
  pageData: any;
  locale?: string;
}

export default function JapaneseToEnglishTranslatorTool({
  pageData,
  locale = 'en',
}: JapaneseToEnglishTranslatorToolProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      // TODO: 替换为你的 API 端点
      const response = await fetch('/api/japanese-to-english-translator', {
        method: 'POST',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'japanese-to-english-translator', {
        onSuccess: () => {},
