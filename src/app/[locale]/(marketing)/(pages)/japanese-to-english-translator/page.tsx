...
import JapaneseToEnglishTranslatorTool from './JapaneseToEnglishTranslatorTool';
...
export async function generateMetadata({
  ...
  return constructMetadata({
    ...
    canonicalUrl: getUrlWithLocale('/japanese-to-english-translator', locale),
    image: '/images/docs/what-is-japanese-to-english-translator.webp',
  });
}

interface JapaneseToEnglishTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function JapaneseToEnglishTranslatorPage(
  props: JapaneseToEnglishTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Japanese To English Translator',
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: '/images/docs/what-is-japanese-to-english-translator.webp',
      alt: 'What is Japanese To English Translator',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src: '/images/docs/japanese-to-english-translator-how-to.webp',
      alt: 'How to use Japanese To English Translator',
    },
    items: [
      {
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-fact-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-fact-2.webp',
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-interest-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-interest-2.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-interest-3.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/japanese-to-english-translator-interest-4.webp',
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <JapaneseToEnglishTranslatorTool
            pageData={pageData}
            locale={locale}
          />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="JapaneseToEnglishTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="JapaneseToEnglishTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="JapaneseToEnglishTranslatorPage.cta" />
      </div>
    </>
  );
}
