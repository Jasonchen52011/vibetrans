...
export async function generateMetadata({
  ...
  return constructMetadata({
    ...
    canonicalUrl: getUrlWithLocale('/albanian-to-english', locale),
    image: '/images/docs/what-is-albanian-to-english.webp',
  });
}
...
export default async function AlbanianToEnglishPage(
  ...
  // Page data for the tool - 使用模板化方法
  const pageData = {
    tool: {
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: '/images/docs/what-is-albanian-to-english.webp',
      alt: 'What is Albanian to English Translator',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src: '/images/docs/albanian-to-english-how-to.webp',
      alt: 'How to use Albanian to English Translator',
    },
    items: [
      {
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-fact-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-fact-2.webp',
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-interest-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-interest-2.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-interest-3.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/albanian-to-english-interest-4.webp',
      ...
      <div className="flex flex-col">
        ...
        <AuroraBackground className="bg-white dark:bg-zinc-900 !pt-12 !h-auto">
          <div className="container max-w-7xl mx-auto px-4 text-center relative z-10 pb-8">
            ...
            {/* User Avatars and Rating - Template Method */}
        ...
        {/* What Is Section - Template Version */}
        <WhatIsSection section={whatIsSection} />

        {/* Examples Section - Template Version */}
        <BeforeAfterSection beforeAfterGallery={examplesData} />

        {/* How to Section - Template Version */}
        <HowTo section={howtoSection} />

        {/* User Interest Blocks - Template Version */}
        <UserScenarios
          section={userInterestSection}
          ctaText={(t as any)('ctaButton')}
        />

        {/* Fun Facts - Template Version */}
        <UserScenarios
          section={funFactsSection}
          ctaText={(t as any)('ctaButton')}
        />

        {/* Highlights - Template Version */}
        <WhyChoose section={highlightsSection} />

        {/* Explore Other Tools - Template Configuration */}
        <ExploreOurAiTools
          toolKeys={[
            'Al Bhed Translator',
        ...
        {/* Testimonials - Template Version */}
        <TestimonialsThreeColumnSection namespace="AlbanianToEnglishPage.testimonials" />

        {/* FAQ - Template Version */}
        <FaqSection namespace="AlbanianToEnglishPage.faqs" />

        {/* CTA - Template Version */}
        <CallToActionSection namespace="AlbanianToEnglishPage.cta" />
      </div>
    </>
  );
}
