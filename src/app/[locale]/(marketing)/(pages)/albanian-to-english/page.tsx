  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="AlbanianToEnglishPage" subNamespace="testimonials" />

        {/* FAQ */}
        <FaqSection namespace="AlbanianToEnglishPage" subNamespace="faqs" />

        {/* CTA */}
        <CallToActionSection namespace="AlbanianToEnglishPage" subNamespace="cta" />
      </div>
    </>
  );
}
