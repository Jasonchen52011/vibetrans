...
type TranslationDirection = 'toHighValyrian' | 'toEnglish';

export default function HighValyrianTranslatorTool({
  pageData,
  locale = 'en',
}: HighValyrianTranslatorToolProps) {
  ...
  const [direction, setDirection] =
    useState<TranslationDirection>('toHighValyrian');
  ...
  const handleTranslate = async () => {
    ...
    try {
      const response = await fetch('/api/high-valyrian-translator', {
        method: 'POST',
      ...
      const data = (await response.json()) as {
        ...
        languageInfo?: {
          ...
          finalDirection: 'toHighValyrian' | 'toEnglish';
        };
      };
  ...
  const handleTitleClick = () => {
    ...
    setOutputText(temp);
    setDirection((prev) =>
      prev === 'toHighValyrian' ? 'toEnglish' : 'toHighValyrian'
    );
    setFileName(null);
    setError(null);
  };
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-3">
          ...
          <div className="flex-1 relative">
            <h2
              ...
              title={direction === 'toHighValyrian' ? 'Switch to High Valyrian → English' : 'Switch to English → High Valyrian'}
            >
            ...
            <textarea
              ...
              placeholder={
                direction === 'toHighValyrian'
                  ? 'Enter English text to convert to High Valyrian...'
          ...
          <div className="flex md:flex-col items-center justify-center md:justify-start md:pt-32">
            <button
              onClick={() => setDirection(direction === 'toHighValyrian' ? 'toEnglish' : 'toHighValyrian')}
