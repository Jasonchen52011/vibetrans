...
export default async function NahuatlTranslatorPage(
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: addCacheBust(t('whatIs.image')),
  ...
  const howtoSection = {
    ...
    image: {
      src: addCacheBust(t('howto.image')),
    ...
    items: [
      {
        ...
        image: {
          src: addCacheBust(t('funFacts.items.0.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust(t('funFacts.items.1.image')),
    ...
    items: [
      {
        ...
        image: {
          src: addCacheBust(t('userInterest.items.0.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust(t('userInterest.items.1.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust(t('userInterest.items.2.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust(t('userInterest.items.3.image')),
  ...
  return (
    <>
      ...
      <div className="flex flex-col">
          ...
          <div className="container max-w-5xl mx-auto px-4 text-center relative z-10 pb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="flex -space-x-3">
                {(() => {
                  const userAvatars = t.raw('hero.userAvatars');
        ...
        <ExploreOurAiTools
          toolKeys={(() => {
            const relatedTools = t.raw('relatedTools');
