...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: `${gt('title')} | VibeTrans`,
    description: gt('description'),
    canonicalUrl: getUrlWithLocale('/nahuatl-translator', locale),
    image: addCacheBust('/images/docs/what-is-nahuatl-translator.webp'),
  });
}

interface NahuatlTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function NahuatlTranslatorPage(
  props: NahuatlTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Nahuatl Translator',
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: addCacheBust((t as any)('whatIs.image')),
  ...
  const howtoSection = {
    ...
    image: {
      src: addCacheBust((t as any)('howto.image')),
    ...
    items: [
      {
        ...
        image: {
          src: addCacheBust((t as any)('funFacts.items.0.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust((t as any)('funFacts.items.1.image')),
    ...
    items: [
      {
        ...
        image: {
          src: addCacheBust((t as any)('userInterest.items.0.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust((t as any)('userInterest.items.1.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust((t as any)('userInterest.items.2.image')),
      ...
      },
      {
        ...
        image: {
          src: addCacheBust((t as any)('userInterest.items.3.image')),
    ...
    <>
      ...
      <div className="flex flex-col">
          ...
          <div className="container max-w-5xl mx-auto px-4 text-center relative z-10 pb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="flex -space-x-3">
                {(() => {
                  const userAvatars = (t as any).raw('hero.userAvatars');
                  const avatarArray = Array.isArray(userAvatars)
                    ? userAvatars
                    : ['male3', 'female4', 'male1', 'female3', 'male4'];
                  return avatarArray.map((avatar: string, i: number) => (
                    <div
                      key={i}
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <NahuatlTranslatorTool pageData={pageData} locale={locale} />
        </div>
        ...
        <ExploreOurAiTools
          toolKeys={(() => {
            const relatedTools = (t as any).raw('relatedTools');
            return Array.isArray(relatedTools)
              ? relatedTools
              : ['Dog Translator', 'Gen Z Translator', 'Rune Translator'];
          })()}
        />

        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="NahuatlTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="NahuatlTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="NahuatlTranslatorPage.cta" />
      </div>
    </>
  );
}
