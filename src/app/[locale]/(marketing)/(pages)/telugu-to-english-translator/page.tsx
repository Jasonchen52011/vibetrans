...
import TeluguToEnglishTranslatorTool from './TeluguToEnglishTranslatorTool';
...
interface TeluguToEnglishTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function TeluguToEnglishTranslatorPage(
  props: TeluguToEnglishTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Telugu To English Translator',
    description: t('description'),
  });
