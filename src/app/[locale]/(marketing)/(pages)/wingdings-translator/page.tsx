...
import WingdingsTranslatorTool from './WingdingsTranslatorTool';
...
interface WingdingsTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function WingdingsTranslatorPage(
  props: WingdingsTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Wingdings Translator',
  ...
  const whatIsSection = {
    ...
    image: {
      ...
      alt: (t as any)('whatIs.imageAlt') || 'What is wingdings-translator',
    },
