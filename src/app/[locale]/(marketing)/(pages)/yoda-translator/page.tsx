...
export default async function YodaTranslatorPage(
  ...
  const whatIsSection = {
    ...
    image: {
      ...
      alt: (t as any)('whatIs.imageAlt') || 'What is yoda-translator',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src:
        (t as any)('howto.image') || '/images/docs/yoda-translator-how-to.webp',
      alt: (t as any)('howto.imageAlt') || 'How to use Yoda Translator',
    },
    items: [
      {
