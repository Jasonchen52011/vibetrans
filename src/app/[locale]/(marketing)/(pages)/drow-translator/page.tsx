...
import DrowTranslatorTool from './DrowTranslatorTool';
...
interface DrowTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function DrowTranslatorPage(
  props: DrowTranslatorPageProps
) {
  const params = await props.params;
  const { locale } = params;
  const t = await getTranslations({ locale, namespace: 'DrowTranslatorPage' });
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <DrowTranslatorTool pageData={pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="DrowTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="DrowTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="DrowTranslatorPage.cta" />
      </div>
    </>
  );
}
