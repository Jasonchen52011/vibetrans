...
interface EnglishToTurkishTranslatorToolProps {
  pageData: any;
  locale?: string;
}

export default function EnglishToTurkishTranslatorTool({
  pageData,
  locale = 'en',
}: EnglishToTurkishTranslatorToolProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      const response = await fetch('/api/english-to-turkish-translator', {
        method: 'POST',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      smartDownload(outputText, 'english-to-turkish-translator', {
        onSuccess: () => {},
