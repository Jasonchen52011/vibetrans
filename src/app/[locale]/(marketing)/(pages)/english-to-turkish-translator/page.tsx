...
import EnglishToTurkishTranslatorTool from './EnglishToTurkishTranslatorTool';
...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: 'EnglishToTurkishTranslatorPage',
  });
  ...
  return constructMetadata({
    ...
    canonicalUrl: getUrlWithLocale('/english-to-turkish-translator', locale),
    image: t('whatIs.image'),
  });
}

interface EnglishToTurkishTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function EnglishToTurkishTranslatorPage(
  props: EnglishToTurkishTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans English To Turkish Translator',
    description: t('description'),
  });
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <EnglishToTurkishTranslatorTool
