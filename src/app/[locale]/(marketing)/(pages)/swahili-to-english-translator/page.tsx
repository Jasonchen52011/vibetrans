...
import SwahiliToEnglishTranslatorTool from './SwahiliToEnglishTranslatorTool';
export async function generateMetadata({
  ...
  const gt = await getTranslations({
    locale,
    namespace: 'SwahiliToEnglishTranslatorPage',
  });

  return constructMetadata({
    title: `${gt('title')} | ${(t as any)('name')}`,
    description: gt('description'),
    canonicalUrl: getUrlWithLocale('/swahili-to-english-translator', locale),
    image: '/images/docs/what-is-swahili-to-english-translator.webp',
  });
}

interface SwahiliToEnglishTranslatorPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function SwahiliToEnglishTranslatorPage(
  props: SwahiliToEnglishTranslatorPageProps
) {
  ...
  const structuredData = buildToolStructuredData({
    name: 'VibeTrans Swahili To English Translator',
  ...
  const whatIsSection = {
    ...
    features: [],
    image: {
      src: '/images/docs/what-is-swahili-to-english-translator.webp',
      alt: 'What is Swahili To English Translator',
    },
  ...
  const howtoSection = {
    ...
    image: {
      src: '/images/docs/swahili-to-english-translator-how-to.webp',
      alt: 'How to use Swahili To English Translator',
    },
    items: [
      {
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-fact-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-fact-2.webp',
    ...
    items: [
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-interest-1.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-interest-2.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-interest-3.webp',
      ...
      },
      {
        ...
        image: {
          src: '/images/docs/swahili-to-english-translator-interest-4.webp',
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <SwahiliToEnglishTranslatorTool pageData={pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="SwahiliToEnglishTranslatorPage.testimonials" />

        {/* FAQ */}
        <FaqSection namespace="SwahiliToEnglishTranslatorPage.faqs" />

        {/* CTA */}
        <CallToActionSection namespace="SwahiliToEnglishTranslatorPage.cta" />
      </div>
    </>
  );
}
