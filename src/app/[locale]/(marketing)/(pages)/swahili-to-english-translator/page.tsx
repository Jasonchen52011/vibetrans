...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'swahiliToEnglishTranslatorPage' });
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="pt-0 pb-12 bg-gradient-to-b from-muted/20 to-background">
          <SwahiliToEnglishTranslatorTool pageData={translatorContent.pageData} locale={locale} />
        </div>
        ...
        {/* Testimonials */}
        <TestimonialsThreeColumnSection namespace="swahiliToEnglishTranslatorPage" subNamespace="testimonials" />

        {/* FAQ */}


        <FaqSection namespace="swahiliToEnglishTranslatorPage" subNamespace="faqs" />

        {/* CTA */}
        <CallToActionSection namespace="swahiliToEnglishTranslatorPage" subNamespace="cta" />
      </div>
    </>
  );
}
