...
import CreoleToEnglishTranslatorTool from './CreoleToEnglishTranslatorTool';
...
interface CreoleToEnglishPageProps {
  params: Promise<{ locale: Locale }>;
}

export default async function CreoleToEnglishPage(
  props: CreoleToEnglishPageProps
) {
  ...
  const structuredData = {
    ...
    '@type': 'WebApplication',
    name: 'VibeTrans Creole to English Translator',
  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        {/* Testimonials */}
        <TestimonialsSection namespace="CreoleToEnglishPage.testimonials" />
