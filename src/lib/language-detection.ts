...
function getTargetLanguagePatterns(language: string): RegExp[] {
  const patterns: Record<string, RegExp[]> = {
    ...
    greek: [
      ...
      /[\u0370-\u03FF]/g,
      // 现代希腊语常见词汇
      /\b(καλημέρα|καλησπέρα|καληνύχτα|ευχαριστώ|παρακαλώ|ναι|όχι|αγάπη|φιλία|ειρήνη|ελευθερία|δημοκρατία|ιστορία|πολιτισμός|γλώσσα|λόγος|χρόνος|κόσμος|άνθρωπος|παιδί|γυναίκα|άνδρας|οικογένεια|σπίτι|δουλειά|σχολείο|φαγητό|νερό|αέρας|φως|σκιάς|ήλιος|σελήνη|αστέρας|θάλασσα|βουνό|δάσος|ποτάμι|πόλη|χώρα|θεός|διάβολος|άγγελος|δίκη|νόμος|αλήθεια|ψέμα|ελπίδα|φόβος|χαρές|λύπη|θυμός|ηρεμία|τάξη|αταξία|υγεία|ασθένεια|ζωή|θάνατος|γέννηση|τέχνη|μουσική|χορός|τραγούδι|ποιήματα|βιβλία|ταινίες|θέατρο|αθλητισμός|ομαδικότητα|ατολμία|παράδεισος|κόλαση|ουρανός|γη|πυρ|νερό|αέρας)\b/i,
      // 古希腊语常见词汇
      /\b(χαῖρε|εὖγε|νῦν|οὐ|μή|ἐγώ|σύ|αὐτός|αὐτή|αὐτό|οὗτος|αὕτη|τοῦτο|τίς|τί|ποῦ|πόθεν|πότε|πῶς|ἵνα|ὅτι|ὡς|γάρ|δέ|τε|μήν|ἀλλά|ἵνα|οὖν|μέν|δἲ|καί|ἢ|εἰ|μὴ|ἐάν|ἄν|οὐκ|οὐχ|οὐμὴ|οὐχὶ)\b/i,
      // 希腊语常用语法标记
      /\b(είμαι|είσαι|είναι|είμαστε|είστε|είναι|έχω|έχεις|έχει|έχουμε|έχετε|έχουν|ήμουν|ήσουν|ήταν|ήμασταν|ήσασταν|ήταν|θα είμαι|θα είσαι|θα είναι|θα είμαστε|θα είστε|θα είναι)\b/i,
      // 希腊字母
      /[αάβγδδέέζήηθίϊΐκλμμννξόοπρρσστυύύϋΰφχψωώ]/g,
    ],
    'middle-english': [
      // 中古英语常见词汇和模式
