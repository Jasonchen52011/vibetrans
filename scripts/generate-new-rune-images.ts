...
const imageConfigs = [
  ...
  {
    prompt:
      'Viking runes carved into ancient stone tablet, glowing with mystical blue energy, forest background, fantasy art style, highly detailed, dramatic lighting',
    filename: 'rune-ancient-carving-mystical.webp',
    type: 'funFact',
  },
  {
    prompt:
      'Norse warrior reading runes by campfire, ancient scroll with Elder Futhark symbols, warm firelight, dramatic atmosphere, digital painting, cinematic',
  ...
  {
    prompt:
      'Modern cosplayer with glowing rune accessories, fantasy costume convention, colorful lights, enthusiastic fans, event photography, vibrant',
    filename: 'rune-cosplay-convention-modern.webp',
    type: 'userInterest',
  },
  {
    prompt:
      'Tabletop gaming session with RPG dice and rune cards, friends playing Dungeons & Dragons, cozy room with fantasy decor, warm lighting, friendly atmosphere',
    filename: 'rune-tabletop-gaming-friends.webp',
    type: 'userInterest',
  },
  {
    prompt:
      'Digital artists collaborating on rune designs, modern studio with computers, creative workspace, team brainstorming, professional environment, bright lighting',
    filename: 'rune-artists-collaboration-studio.webp',
    type: 'userInterest',
  },
  {
    prompt:
      'Live streamer setup with rune-themed channel branding, professional streaming equipment, RGB lighting, modern gaming setup, content creation',
...
async function generateSingleImage(
  ...
  try {
    ...
    logInfo(`  Prompt: ${config.prompt.substring(0, 100)}...`);
 ...
 */
async function main() {
  log('🖼️  生成Rune Translator新图片', 'bright');
  log('='.repeat(60), 'cyan');
