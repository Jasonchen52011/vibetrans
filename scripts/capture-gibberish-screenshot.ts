...
async function captureGibberishScreenshot() {
  const url = 'http://localhost:3000/gibberish-translator';
  const outputPath = path.join(
    process.cwd(),
    'public/images/docs/gibberish-translator-how-to.webp'
  );
...
captureGibberishScreenshot().catch(console.error);
