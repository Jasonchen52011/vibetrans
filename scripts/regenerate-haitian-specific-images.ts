...
async function main() {
  ...
  console.log('1. What is Haitian Creole Translator Plus (translation-tool-plus.webp)');
  ...
  if (result.success) {
    console.log('✅ 图片生成成功');
    console.log('生成的图片：');
    console.log('- translation-tools-plus.webp → 需要重命名为 translation-tool-plus.webp');
    console.log('- creole-language-fact.webp → 需要重命名为 creole-language-spread.webp');
    console.log('- precise-translation.webp → 需要重命名为 language-clarity.webp');
    process.exit(0);
  } else {
