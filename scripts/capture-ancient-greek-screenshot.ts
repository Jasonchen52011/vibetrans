...
async function captureAncientGreekScreenshot() {
  const url = 'http://localhost:3000/ancient-greek-translator';
  const outputPath = path.join(
    process.cwd(),
    'public/images/docs/ancient-greek-translator-how-to.webp'
  );
...
captureAncientGreekScreenshot().catch(console.error);
