...
async function testMinimaxAPI() {
  console.log('🔍 检查环境变量:');
  console.log('MINIMAX_ANTHROPIC_API_KEY:', process.env.MINIMAX_ANTHROPIC_API_KEY ? '✅ 已设置' : '❌ 未设置');
  console.log('MINIMAX_ANTHROPIC_BASE_URL:', process.env.MINIMAX_ANTHROPIC_BASE_URL);
