...
**Neutral Theme** - Default light theme with clean colors

    </Tab>

    <Tab value='black'>

**Black Theme** - Dark theme with high contrast

    </Tab>

    <Tab value='vitepress'>

**Vitepress Theme** - Documentation-focused styling

    </Tab>

    <Tab value='dusk'>

**Dusk Theme** - Warm dark tones

    </Tab>

    <Tab value='Catppuccin'>

**Catppuccin Theme** - Popular pastel colors
